                        ...
                        for opt_sel_method in ${opt_sel_methods[@]}; do
                            for num_sel_block in ${num_sel_blocks[@]}; do
                                for block_size in ${block_sizes[@]}; do
                                    echo ${func}.${filename}.${num_frames}.${width}.${height}.${block_ws[$block_size]}.${block_hs[$block_size]}.${num_sel_block}.${opt_delta}.${opt_scope}.${opt_sel_method}.${opt_swap_mat}.${drop_rate}.${seed}
                                    sed "s/INPUT_DIR/${input_dir}/g; s/FILENAME/${filename}/g;s/NUM_FRAMES/${num_frames}/g;s/BLOCK_HEIGHT/${block_hs[$block_size]}/g;s/BLOCK_WIDTH/${block_ws[$block_size]}/g;s/WIDTH/${width}/g;s/HEIGHT/${height}/g;s/OPT_DELTA/${opt_delta}/g; s/NUM_SEL_BLOCKS/${num_sel_block}/g; s/OPT_SCOPE/${opt_scope}/g; s/OPT_SEL_METHOD/${opt_sel_method}/g;; s/OPT_SWAP_MAT/${opt_swap_mat}/g;s/SEED/${seed}/g;s/DROP_RATE/${drop_rate}/g" ${func}.mother.sh > tmp.${func}.${filename}.${num_frames}.${width}.${height}.${block_ws[$block_size]}.${block_hs[$block_size]}.${num_sel_block}.${opt_delta}.${opt_scope}.${opt_sel_method}.${opt_swap_mat}.${drop_rate}.${seed}.sh
                                    sed "s/XXX/${filename}.${num_frames}.${width}.${height}.${block_ws[$block_size]}.${block_hs[$block_size]}.${num_sel_block}.${opt_delta}.${opt_scope}.${opt_sel_method}.${opt_swap_mat}.${drop_rate}.${seed}/g" ${func}.mother.condor > tmp.${func}.${filename}.${num_frames}.${width}.${height}.${block_ws[$block_size]}.${block_hs[$block_size]}.${num_sel_block}.${opt_delta}.${opt_scope}.${opt_sel_method}.${opt_swap_mat}.${drop_rate}.${seed}.condor
                                    condor_submit tmp.${func}.${filename}.${num_frames}.${width}.${height}.${block_ws[$block_size]}.${block_hs[$block_size]}.${num_sel_block}.${opt_delta}.${opt_scope}.${opt_sel_method}.${opt_swap_mat}.${drop_rate}.${seed}.condor
                                done
                            done
                        done
                    done

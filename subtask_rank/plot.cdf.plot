...
plot data_dir."tm_abilene.od..".param.".cdf.txt" using 1:2 with lines ls 1 title '{/Helvetica=28 Abilene}', \
     ...
     data_dir."Mob-Recv1run1.dat0_matrix.mat_dB.txt.".param.".cdf.txt" using 1:2 with lines ls 5 title '{/Helvetica=28 CSI}', \
     data_dir."tm_telos_rssi.txt.".param.".cdf.txt" using 1:2 with lines ls 6 title '{/Helvetica=28 Cister RSSI}', \
     data_dir."tm_multi_loc_rssi.txt.".param.".cdf.txt" using 1:2 with lines ls 7 title '{/Helvetica=28 CU RSSI}'
